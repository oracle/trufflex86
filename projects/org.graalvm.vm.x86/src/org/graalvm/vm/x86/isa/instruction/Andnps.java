...
public class Andnps extends AMD64Instruction {
    ...
    protected Andnps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Andnps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"andnps", operand1.toString(), operand2.toString()};
    }
}
