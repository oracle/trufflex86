...
public class Andps extends AMD64Instruction {
    ...
    protected Andps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Andps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"andps", operand1.toString(), operand2.toString()};
    }
}
