...
public class Pxor extends AMD64Instruction {
    ...
    protected Pxor(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pxor(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"pxor", operand1.toString(), operand2.toString()};
    }
}
