...
public class Minsd extends AMD64Instruction {
    ...
    protected Minsd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Minsd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"minsd", operand1.toString(), operand2.toString()};
    }
}
