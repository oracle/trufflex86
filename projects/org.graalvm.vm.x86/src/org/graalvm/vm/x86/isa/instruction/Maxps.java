...
public class Maxps extends AMD64Instruction {
    ...
    protected Maxps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Maxps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.maxPackedF32(b);
    ...
    protected String[] disassemble() {
        return new String[]{"maxps", operand1.toString(), operand2.toString()};
    }
}
