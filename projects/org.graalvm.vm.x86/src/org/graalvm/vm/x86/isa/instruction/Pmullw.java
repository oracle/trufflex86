...
public class Pmullw extends AMD64Instruction {
    ...
    protected Pmullw(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pmullw(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.mulPackedI16(b);
    ...
    protected String[] disassemble() {
        return new String[]{"pmullw", operand1.toString(), operand2.toString()};
    }
}
