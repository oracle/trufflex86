...
public class Mulpd extends AMD64Instruction {
    ...
    protected Mulpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Mulpd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 prod = a.mulDouble(b);
        writeDst.executeI128(frame, prod);
        return next();
    }

    @Override
    protected String[] disassemble() {
        return new String[]{"mulpd", operand1.toString(), operand2.toString()};
    }
}
