...
public class Divps extends AMD64Instruction {
    ...
    protected Divps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Divps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"divps", operand1.toString(), operand2.toString()};
    }
}
