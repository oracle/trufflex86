...
public class Xorps extends AMD64Instruction {
    ...
    protected Xorps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Xorps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"xorps", operand1.toString(), operand2.toString()};
    }
}
