...
public class AMD64Opcode {
    ...
    public static final byte ADDSUBPS_X_XM = (byte) 0xD0;
    ...
    public static final byte BTS_RM_I8 = (byte) 0xBA;
    ...
    public static final byte CVTSD2SI = 0x2D;
    ...
    public static final byte PSLLQ_X_XM = (byte) 0xF3;

    public static final byte PSRAD_X_XM = (byte) 0xE2;

    public static final byte PSRLD_X_XM = (byte) 0xD2;

    public static final byte PSRLQ_X_XM = (byte) 0xD3;
    ...
    public static final byte PUNPCKHQDQ = 0x6D;
