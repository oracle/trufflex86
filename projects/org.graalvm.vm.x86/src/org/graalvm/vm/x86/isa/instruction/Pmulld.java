...
public class Pmulld extends AMD64Instruction {
    ...
    protected Pmulld(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pmulld(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.mulPackedI32(b);
    ...
    protected String[] disassemble() {
        return new String[]{"pmulld", operand1.toString(), operand2.toString()};
    }
}
