...
public class Cvtdq2pd extends AMD64Instruction {
    ...
    protected Cvtdq2pd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Cvtdq2pd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"cvtdq2pd", operand1.toString(), operand2.toString()};
    }
}
