...
public class Subps extends AMD64Instruction {
    ...
    protected Subps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Subps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"subps", operand1.toString(), operand2.toString()};
    }
}
