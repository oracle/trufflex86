...
public class Comiss extends AMD64Instruction {
    ...
    protected Comiss(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Comiss(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"comiss", operand1.toString(), operand2.toString()};
    }
}
