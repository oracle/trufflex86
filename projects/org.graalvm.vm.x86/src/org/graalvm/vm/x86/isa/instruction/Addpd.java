...
public class Addpd extends AMD64Instruction {
    ...
    protected Addpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Addpd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"addpd", operand1.toString(), operand2.toString()};
    }
}
