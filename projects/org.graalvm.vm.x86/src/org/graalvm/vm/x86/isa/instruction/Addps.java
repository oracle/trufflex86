...
public class Addps extends AMD64Instruction {
    ...
    protected Addps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Addps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"addps", operand1.toString(), operand2.toString()};
    }
}
