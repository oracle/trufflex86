...
public abstract class LockInc extends AMD64Instruction {
    ...
    protected LockInc(long pc, byte[] instruction, Operand operand) {
    ...
    public static class LockIncb extends LockInc {
        public LockIncb(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public static class LockIncw extends LockInc {
        public LockIncw(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public static class LockIncl extends LockInc {
        public LockIncl(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public static class LockIncq extends LockInc {
        public LockIncq(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"lock inc", operand.toString()};
    }
}
