...
public class Xorpd extends AMD64Instruction {
    ...
    protected Xorpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Xorpd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 xor = a.xor(b);
        writeDst.executeI128(frame, xor);
        return next();
    }

    @Override
    protected String[] disassemble() {
        return new String[]{"xorpd", operand1.toString(), operand2.toString()};
    }
}
