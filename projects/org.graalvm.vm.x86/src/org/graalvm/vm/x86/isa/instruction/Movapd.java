...
public class Movapd extends AMD64Instruction {
    ...
    protected Movapd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Movapd(long pc, byte[] instruction, OperandDecoder operands) {
        this(pc, instruction, operands, false);
    }

    public Movapd(long pc, byte[] instruction, OperandDecoder operands, boolean swap) {
    ...
    protected String[] disassemble() {
        return new String[]{"movapd", operand1.toString(), operand2.toString()};
    }
}
