...
public class Mulps extends AMD64Instruction {
    ...
    protected Mulps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Mulps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"mulps", operand1.toString(), operand2.toString()};
    }
}
