...
public class Mulsd extends AMD64Instruction {
    ...
    protected Mulsd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Mulsd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"mulsd", operand1.toString(), operand2.toString()};
    }
}
