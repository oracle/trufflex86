...
public class Maxss extends AMD64Instruction {
    ...
    protected Maxss(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Maxss(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"maxss", operand1.toString(), operand2.toString()};
    }
}
