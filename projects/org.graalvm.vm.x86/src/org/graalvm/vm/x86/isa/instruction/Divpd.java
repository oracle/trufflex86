...
public class Divpd extends AMD64Instruction {
    ...
    protected Divpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Divpd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"divpd", operand1.toString(), operand2.toString()};
    }
}
