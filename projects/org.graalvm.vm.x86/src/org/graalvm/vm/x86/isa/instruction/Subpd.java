...
public class Subpd extends AMD64Instruction {
    ...
    protected Subpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Subpd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"subpd", operand1.toString(), operand2.toString()};
    }
}
