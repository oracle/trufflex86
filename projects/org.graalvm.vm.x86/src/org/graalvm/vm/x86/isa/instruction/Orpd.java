...
public class Orpd extends AMD64Instruction {
    ...
    protected Orpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Orpd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"orpd", operand1.toString(), operand2.toString()};
    }
}
