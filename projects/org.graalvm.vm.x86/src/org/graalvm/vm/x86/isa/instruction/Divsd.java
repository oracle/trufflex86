...
public class Divsd extends AMD64Instruction {
    ...
    protected Divsd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Divsd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"divsd", operand1.toString(), operand2.toString()};
    }
}
