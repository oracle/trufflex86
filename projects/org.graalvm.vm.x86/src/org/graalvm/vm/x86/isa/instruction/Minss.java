...
public class Minss extends AMD64Instruction {
    ...
    protected Minss(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Minss(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"minss", operand1.toString(), operand2.toString()};
    }
}
