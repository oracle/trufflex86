...
public class Andnpd extends AMD64Instruction {
    ...
    protected Andnpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Andnpd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"andnpd", operand1.toString(), operand2.toString()};
    }
}
