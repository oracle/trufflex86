...
public class Por extends AMD64Instruction {
    ...
    protected Por(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Por(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"por", operand1.toString(), operand2.toString()};
    }
}
