...
public class Mulss extends AMD64Instruction {
    ...
    protected Mulss(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Mulss(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"mulss", operand1.toString(), operand2.toString()};
    }
}
