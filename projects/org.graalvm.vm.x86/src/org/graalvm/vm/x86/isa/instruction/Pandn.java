...
public class Pandn extends AMD64Instruction {
    ...
    protected Pandn(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pandn(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"pandn", operand1.toString(), operand2.toString()};
    }
}
