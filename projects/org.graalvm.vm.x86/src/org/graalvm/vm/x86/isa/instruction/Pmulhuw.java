...
public class Pmulhuw extends AMD64Instruction {
    ...
    protected Pmulhuw(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pmulhuw(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.mulHighUnsignedPackedI16(b);
    ...
    protected String[] disassemble() {
        return new String[]{"pmulhuw", operand1.toString(), operand2.toString()};
    }
}
