...
public class Comisd extends AMD64Instruction {
    ...
    protected Comisd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Comisd(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"comisd", operand1.toString(), operand2.toString()};
    }
}
