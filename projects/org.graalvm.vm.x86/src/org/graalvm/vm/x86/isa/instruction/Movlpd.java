...
public class Movlpd extends AMD64Instruction {
    ...
    protected Movlpd(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Movlpd(long pc, byte[] instruction, OperandDecoder operands) {
        this(pc, instruction, operands, false);
    }

    public Movlpd(long pc, byte[] instruction, OperandDecoder operands, boolean swap) {
    ...
    protected String[] disassemble() {
        return new String[]{"movlpd", operand1.toString(), operand2.toString()};
    }
}
