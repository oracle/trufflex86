...
public class Pand extends AMD64Instruction {
    ...
    protected Pand(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pand(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    protected String[] disassemble() {
        return new String[]{"pand", operand1.toString(), operand2.toString()};
    }
}
