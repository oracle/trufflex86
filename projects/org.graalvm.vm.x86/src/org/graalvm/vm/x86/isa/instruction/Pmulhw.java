...
public class Pmulhw extends AMD64Instruction {
    ...
    protected Pmulhw(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pmulhw(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.mulHighPackedI16(b);
    ...
    protected String[] disassemble() {
        return new String[]{"pmulhw", operand1.toString(), operand2.toString()};
    }
}
