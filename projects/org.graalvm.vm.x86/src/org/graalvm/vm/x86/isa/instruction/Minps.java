...
public class Minps extends AMD64Instruction {
    ...
    protected Minps(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Minps(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.minPackedF32(b);
    ...
    protected String[] disassemble() {
        return new String[]{"minps", operand1.toString(), operand2.toString()};
    }
}
