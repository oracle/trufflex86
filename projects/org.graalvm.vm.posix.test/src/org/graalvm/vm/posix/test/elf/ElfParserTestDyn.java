...
public class ElfParserTestDyn {
    ...
    private void testProgramHeader(int n, int p_type, long p_offset, long p_vaddr, long p_paddr, long p_filesz, long p_memsz, int p_flags, long p_align) {
    ...
    private void testSectionHeader(int i, String name, int type, int addr, int off, int size, int es, int flg, int lk, int inf, int al) {
